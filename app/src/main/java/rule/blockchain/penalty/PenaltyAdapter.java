...
public class PenaltyAdapter extends RecyclerView.Adapter<PenaltyAdapter.ItemViewHolder> {

    private Context mcontext;
    private List<Penalty> mItemList;

    public PenaltyAdapter(@NonNull List<Penalty> ItemList, Context context) {
    ...
    public void onBindViewHolder(@NonNull final ItemViewHolder holder, int position) {
        ...
        Penalty loan = mItemList.get(position);
        Member request = loan.getMember();
        Log.e("request ", request.toString());

        holder.txtPatientName.setText("Name: " + request.getName());

        holder.txtAge.setText("Aadhar No: " + request.getAdharNumber());
        holder.txtWeight.setText("Mobile: " + request.getMobile());
        holder.txtHeight.setText("Email: " + request.getEmail());
        holder.txtDate.setText("Penalty Amount: " + loan.getPenaltyAmount() + " Rs.");
        holder.txtHospital.setText("Comment : " + loan.getPenaltyDescription());
        holder.txtMedicalCondition.setVisibility(View.GONE);
